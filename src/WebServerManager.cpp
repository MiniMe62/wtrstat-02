        ...
        <div class="chart-box">
            ...
            <div class="chart-controls">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn-period active" id="btnToggleTempTooltip" onclick="toggleTempTooltip()" title="Zapnúť / Vypnúť bublinové hodnoty">💬 Bubliny</button>
                </div>
            </div>
        ...
        <div class="chart-box">
            ...
            <div class="chart-controls">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn-period active" id="btnToggleRoseTooltip" onclick="toggleRoseTooltip()" title="Zapnúť / Vypnúť bublinové hodnoty">💬 Bubliny</button>
                </div>
            </div>
