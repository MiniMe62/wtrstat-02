...
<body>
    <div class="container">
        ...
        <div class="chart-box">
            ...
            <div class="chart-controls">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn-period" id="btnTempPeriod24h" onclick="setTempPeriod('24h')">📅 24 Hodín (TS)</button>
                    <button class="btn-period" id="btnTempPeriod3d" onclick="setTempPeriod('3d')">📆 3 Dni (TS)</button>
                    <button class="btn-period" id="btnTempPeriod7d" onclick="setTempPeriod('7d')">🗓️ 7 Dní (TS)</button>
                </div>
            </div>
        ...
        <!-- Wind Rose Section -->
        <div class="chart-box">
            <div class="section-title">🌪️ Veterná Ružica (Rozdelenie Smerov a Sily Vetra)</div>
            <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 8px;">
            ...
            <div class="chart-controls">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn-period" id="btn24h" onclick="setPeriod('24h')">📅 24 Hodín (TS)</button>
                    <button class="btn-period" id="btn3d" onclick="setPeriod('3d')">📆 3 Dni (TS)</button>
                    <button class="btn-period" id="btn7d" onclick="setPeriod('7d')">🗓️ 7 Dní (TS)</button>
                </div>
            </div>
